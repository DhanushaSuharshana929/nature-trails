                                ...
                                <form class="form-horizontal" method="post"  id="form-data" enctype="multipart/form-data"> 
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="title" class="form-control"  value="<?php echo $DINING->title; ?>"  name="title"  required="TRUE">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="number" id="price" class="form-control"  value="<?php echo $DINING->price; ?>"  name="price" min="0" required="TRUE">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="short_description" name="short_description" class="form-control" value="<?php echo $DINING->short_description; ?>"  name="short_description">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" id="id" value="<?php echo $DINING->id; ?>" name="id"/>
