            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Dining</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="create-dining-type.php">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/dining.php" class="form-horizontal" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    if (count($DINING->getDiningByType($DILING_TYPE->id)) > 0) {
                                                        foreach ($DINING->getDiningByType($DILING_TYPE->id) as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/dining/<?php echo $img["image_name"]; ?>" alt=""/>
