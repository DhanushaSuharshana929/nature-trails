                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    if (count($ROOM_PHOTO) > 0) {
                                        foreach ($ROOM_PHOTO as $key => $room_photo) {
                                            ?>
                                            <div class="col-md-3"  id="div<?php echo $room_photo['id']; ?>">
                                                ...
                                                <div class="img-caption">
                                                    ...
                                                    <div class="d">
                                                        <a href="#"  class="delete-room-photo" data-id="<?php echo $room_photo['id']; ?>"> <button class="glyphicon glyphicon-trash delete-btn"></button></a>
                                                        <a href="edit-room-photo.php?id=<?php echo $room_photo['id']; ?>"> <button class="glyphicon glyphicon-pencil edit-btn"></button></a>
                                                        <a href="arrange-room-photos.php?id=<?php echo $id; ?>">  <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        ?> 
                                        <b style="padding-left: 15px;">No Room photos in the database.</b> 
                                    <?php } ?> 
