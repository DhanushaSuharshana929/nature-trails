...
class Order {
    ...
    public function updateStatus($id, $ref) {
        ...
        $db = new Database();
        $id = (int) $id;
        $query = "UPDATE `order` SET `reference` = '" . mysql_real_escape_string($ref) . "', `status` = 1 WHERE `id` = " . $id;
    ...
    public function getPaidOrders() {
        ...
        $query = "SELECT * FROM `order` WHERE `status` = '1' ORDER BY `id` ASC";
    ...
    public function getRefundOrders() {
        ...
        $query = "SELECT * FROM `order` WHERE `status` = '2' ORDER BY `id` ASC";
    ...
    public function getUnsuccessfulOrders() {

        $db = new Database();

        $query = "SELECT * FROM `order` WHERE `status` = '0' ORDER BY `id` ASC";
                    ...
                    <html>
                        ...
                        <body>
                            ...
                            <div style="margin-top: 20px;">
                                ...
                                <p>Thank you for your business. Please send your payment within 7 days of receiving this order.</p>
                            </div>
                            <div style="text-align: center; margin: 35px 0px;">
                                <a href="http://' . $site . '/order-pay.php?id=' . $inv["id"] . '" style="padding: 15px; font-weight: bold; text-decoration: none; background-color: #ff4200; color: #dfdfdf; border-radius: 3px;">Complete Payment</a>
                            </div>
                        </body>
                    </html>';
        ...
        if ($inv) {
            ...
            if ($status === 'error') {
                $repay = '<div>
                            ...
                            <div style="text-align: center; margin: 35px 0px;">
                                <a href="http://' . $site . '/order-pay.php?id=' . $id . '" style="padding: 15px; font-weight: bold; text-decoration: none; background-color: #ff4200; color: #dfdfdf; border-radius: 3px;">Complete Payment</a>
                            </div>';
            } else {
                $repay = '';
            }
    ...
    public function ordersCountByDate($date) {

        $query = "SELECT count(1) FROM `order` WHERE (`payment_date` = '" . $date . "') AND (`status` = 1) ";
        $db = new Database();
        $result = $db->readQuery($query);
